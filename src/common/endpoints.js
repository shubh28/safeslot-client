...
export const ADD_COMMENT_URL = (post_id) => `${API_HOST}${API_PATH}/post/${post_id}/comment`;
export const UPDATE_COMMENT_URL = (comment_id) => `${API_HOST}${API_PATH}/comment/${comment_id}`;
