        ...
        <div className="top-fold">
          <div className="overlay">
            <div className="login-btn">
              ...
              {isLoggedIn ? (
                <Button tag={Link} to="/bookings" outline color="primary">
                  My Bookings
                </Button>
              ) : (
                <Button tag={Link} to="/login" outline color="primary">
                  Login
                </Button>
              )}
            </div>
            <h2 className="hero-text">Safe Slot</h2>
            ...
            <div className="book-now-btn">
              <Button outline color="primary" onClick={scrollToBottom}>
                Book Now
              </Button>
            </div>
          </div>
        ...
        <div className="container store">
              ...
              {this.state.locations.map(location => {
                return (
                  <DropdownItem
                    tag="a"
                    key={location.id}
                    onClick={() => this.handlePlaceSelect(location.place_name)}
                  >
                    {location.place_name}
                  </DropdownItem>
                );
          ...
          <div className="cities">
            ...
            <Button
              ...
              color="info"
              size="sm"
              onClick={() => this.handlePlaceSelect('Ghaziabad')}
            >
              Ghaziabad
            </Button>{' '}
            <Button
